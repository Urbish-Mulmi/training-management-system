...
const AssignmentManagement = () => {
  ...
  // Frontend-only due date validation
  ...
  const handleSaveGrade = async (submissionId) => {
    ...
    try {
      ...
      if (selectedAssignmentForSubmissions) {
        const res = await getAssignmentSubmissions(
          selectedAssignmentForSubmissions._id
        );
    ...
    try {
      ...
      if (editingAssignment) {
        /*
          ...
          Creating first prevents losing the old assignment
          if creation of the new assignment fails.
        */
  ...
  /*
    Minimum date for the browser picker.

    This is only a UI restriction.
    validateDueDate() above is the actual frontend validation.
  */
  const getMinDate = () => {
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            ...
            >
              ...
              <div>
                ...
                {editingAssignment && (
                  <p className="text-[11px] text-gray-400 mt-1">
                    When editing, upload the PDF again if you want the new assignment to have an attachment.
                  </p>
                )}
              ...
              <div className="space-y-4">
                ...
                {submissions.map((sub) => {
                  ...
                  return (
                    ...
                    <div
                      key={sub._id}
                      className="border border-gray-200 rounded-xl p-4 space-y-3 bg-gray-50/50 text-xs"
                    >
